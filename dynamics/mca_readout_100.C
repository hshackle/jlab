...
void mca_readout_100(){
  ...
  TH2F *h1 = new TH2F("Data", "Electron Count Rate", 24, 200, 500, 12, 3.4, 4.5);
  while (1){
  ...
  data->close();
    ...
    data->open(Form("hshackle-3.8kV-112G.Spe"));
  bin = 0;
  ...
  while (1){
    ...
    h1->Fill(bin*0.286286 - .591431, 3.8, freq);
    bin += 1;
 ...
 data->close();
 data->open(Form("hshackle-3.7kV-112G.Spe"));
  bin = 0;
  ...
  while (1){
    ...
    h1->Fill(bin*0.286286 - .591431, 3.7, freq);
    bin += 1;
  ...
  data->close();
    data->open(Form("hshackle-3.6kV-112G.Spe"));
  bin = 0;
  ...
  while (1){
    ...
    h1->Fill(bin*0.286286 - .591431, 3.65, freq);
    cout << freq << endl;
    bin += 1;
  ...
  data->close();
    ...
    data->open(Form("hshackle-3.5kV-112G.Spe"));
  bin = 0;
  ...
  while (1){
    ...
    h1->Fill(bin*0.286286 - .591431, 3.5, freq);
    bin += 1;
 ...
 data->close();
     data->open(Form("hshackle-3.4kV-112G.Spe"));
  bin = 0;
  ...
  while (1){
    ...
    h1->Fill(bin*0.286286 - .591431, 3.4, freq);
    bin += 1;
